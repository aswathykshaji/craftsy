...
<div class="row" style="padding-left: 25%">
   ...
   //out.println("hello1");
    ...
    <div class="col-md-3"  id="subcat">
        ...
        <select class="input-sm form-control w-sm inline v-middle" id="subcategory_id" name="subcategory_id"  onchange="displayproduct()" >
            <option value="0">...SELECT....</option>
...
//                    where category_id='" + + "' and subcategory_id='" + + "' "
                    ...
                    while (rs.next()) {
            %>
            <div class="col-md-4 col-xs-6" id="product">
