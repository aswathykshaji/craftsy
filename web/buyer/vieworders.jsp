                            ...
                            <table class="table">
                                ...
                                <%
                                    try {
                                        ...
                                        String Query = "SELECT * FROM request r INNER JOIN login l on r.customer_id=l.login_id INNER JOIN product p on r.product_id=p.product_id inner join feedback f on f.product_id=p.product_id where r.customer_id='" + custid + "'";
