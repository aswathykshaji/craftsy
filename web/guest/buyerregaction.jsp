...
String password = request.getParameter("password");
 ...
 String sql4 = "insert into customerreg(customer_name,address,district_id,location,email,phone,password,login_id)values('" + 
name + "','" + address + "','" + district + "','" + location + "','" + email + "','" + phone + "','" + password + "',"+lid+")";
